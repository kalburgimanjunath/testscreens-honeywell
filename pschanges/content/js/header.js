define('header', ['jquery', 'underscore', 'toastr', 'ko', 'config', 'router', 'datacontext'], function ($, _, toastr, ko, config, router, datacontext) {
    ...
    pageheaderViewmodel = function () {
        var self = this;
        self.toggleclass = ko.observable("");
        ...
        self.menutoggle = function (data, event) {
            //$("#wrapper").toggleClass("open");
            var cls = self.toggleclass() == "open" ? "" : "open";
    ...
    initialize = function (configuration) {
        if (pageModel == null) {
            ...
            var hdrelement = document.getElementById("page-header");
            if (hdrelement != null && hdrelement != undefined) {
                ko.cleanNode(hdrelement);
                ko.applyBindings(pageModel, hdrelement);
            }
